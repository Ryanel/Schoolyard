        ...
        public static readonly Opcode[] OpCodes =
{
            ...
            new Opcode(0x09, "add hl, bc"          , 1, (c,i) => {c.HL = c.alu.Add(c.HL, c.BC, RegFlags.H | RegFlags.C, RegFlags.None, RegFlags.N); return 8;}),
            ...
            new Opcode(0x19, "add hl, de"          , 1, (c,i) => {c.HL = c.alu.Add(c.HL, c.DE, RegFlags.H | RegFlags.C, RegFlags.None, RegFlags.N); return 8;}),
            ...
            new Opcode(0x29, "add hl, hl"          , 1, (c,i) => {c.HL = c.alu.Add(c.HL, c.HL, RegFlags.H | RegFlags.C, RegFlags.None, RegFlags.N); return 8;}),
            ...
            new Opcode(0x96, "sub a, (HL)"         , 1, (c,i) => {c.A = c.alu.Sub(c.A, c.mem.Read8(c.HL),RegFlags.Z | RegFlags.H | RegFlags.C, RegFlags.N); return 8;}),
            new Opcode(0x97, "sub a, a"            , 1, (c,i) => {c.A = c.alu.Sub(c.A, c.A, RegFlags.Z | RegFlags.H | RegFlags.C, RegFlags.N); return 4;}),
            ...
            new Opcode(0x9E, "sbc a, (HL)"         , 1, (c,i) => {c.A = c.alu.Sbc(c.A, c.mem.Read8(c.HL),RegFlags.Z | RegFlags.H | RegFlags.C, RegFlags.N); return 8;}),
            new Opcode(0x9F, "sbc a, a"            , 1, (c,i) => {c.A = c.alu.Sbc(c.A, c.A, RegFlags.Z | RegFlags.H | RegFlags.C, RegFlags.N); return 4;}),     
            // 0xA0
